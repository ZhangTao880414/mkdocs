...
```shell
root@master:/opt# echo 'taotaolinux'>taotaolinux.txt
root@master:/opt# pscp  -h  ip.txt taotaolinux.txt   /tmp/
[1] 12:17:42 [SUCCESS] node2
[2] 12:17:42 [SUCCESS] node1
[3] 12:17:42 [SUCCESS] node3
root@master:/opt# pssh -h ip.txt -i 'ls /tmp/taotaolinux.txt'
...
```
root@master:/opt# pslurp -h ip.txt  -L /opt /tmp/taotaolinux.txt new_taotaolinux.conf
...
上边是，将所有远程主机 /tmp/taotaolinux.txt复制到本地主机/home/目录下，并且重新命名为new_taotaolinux.conf, -L 来指定本地文件路径
