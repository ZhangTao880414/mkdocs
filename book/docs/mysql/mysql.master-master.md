...
mysql> insert into taotaolinux(name,age,score) values("taotaolinux from leco data",18,88);
...
| id | name                | age | score |
+----+---------------------+-----+-------+
|  1 | taotaolinux from leco data  |  18 |    88 |
|  3 | taotaolinux1 from leco data |  40 |    88 |
+----+---------------------+-----+-------+
...
Database changed
mysql> insert into taotaolinux(name,age,score) values("taotaolinux2 from manage01",18,66);
Query OK, 1 row affected (0,13 sec)

mysql> insert into taotaolinux(name,age,score) values("taotaolinux3 from manage01",40,66);
...
|  1 | taotaolinux from leco data  |  18 |    88 |
|  3 | taotaolinux1 from leco data |  40 |    88 |
|  4 | taotaolinux2 from manage01  |  18 |    66 |
|  6 | taotaolinux3 from manage01  |  40 |    66 |
+----+---------------------+-----+-------+
