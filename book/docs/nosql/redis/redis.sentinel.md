...
![redis-sentinel原理](../../pictures/nosql/redis/redis-sentinel/p1.png)
...
![redis-sentinel 开始架构图](../../pictures/nosql/redis/redis-sentinel/p2.png)
...
![redis-sentinel master宕机开始架构图](../../pictures/nosql/redis/redis-sentinel/p3.png)
