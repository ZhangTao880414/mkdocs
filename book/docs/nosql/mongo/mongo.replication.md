...
![demo](../../pictures/nosql/mongo/p2.png)

![primary正常工作](../../pictures/nosql/mongo/p3.png)

primary挂了以后

![primary挂了以后](../../pictures/nosql/mongo/p4.png)
...
[离线安装文档](https://taotaolinux.github.io/books/linux/nosql/mongo/mongo.index/)
...
把node3，也就是上面的隐藏节点删除，然后再以延时节点添加进来。
...
```
repset:PRIMARY> for(var i=0;i<1000;i++){db.test.insert({"name":"taotaolinux"+i,"age":10})}
WriteResult({ "nInserted" : 1 })
repset:PRIMARY> db.test.count()
12000
```
