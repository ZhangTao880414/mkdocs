...
&#160; &#160; &#160; &#160;而本文主要讲的还是文本方式登录的情况：当看到mingetty的登录界面时，就可以输入用户名和密码来登录系统了。
...
## 8. 模式切换
&#160; &#160; &#160; &#160;图形模式与文字模式的切换方式。Linux预设提供了六个命令窗口终端机让来登录。

&#160; &#160; &#160; &#160;默认登录的就是第一个窗口，也就是tty1，这个六个窗口分别为tty1,tty2 … tty6，你可以按下Ctrl + Alt + F1 ~ F6 来切换它们。
...
!!! note "详细流程"
    ...
    以Grub为例来讲解吧，毕竟用lilo和spfdisk的人并不多。
