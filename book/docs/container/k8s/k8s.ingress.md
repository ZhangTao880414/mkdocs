...
<center>![service类型](../../pictures/container/k8s/ingress1.png)</center>

<center>![service类型](../../pictures/container/k8s/ingress2.png)</center>
...
!!! note "修改部分"
    ...
    ```
>  绑定在哪个机器上就只能在哪个机器上访问，也可以部署成DaemonSet模式，也就是守护进程模式，这样每台机器上都有，前面在做一个负载均衡即可。
...
<center>![service类型](../../pictures/container/k8s/ingress3.png)</center>
...
<center>![service类型](../../pictures/container/k8s/ingress4.png)</center>

<center>![service类型](../../pictures/container/k8s/ingress5.png)</center>
