...
<center>![service类型](../../pictures/container/k8s/s1.png)</center>

<center>![service类型](../../pictures/container/k8s/s2.png)</center>

<center>![service类](../../pictures/container/k8s/s3.png)</center>


## 3. service 代理模式

<center>![代理模式](../../pictures/container/k8s/ipables_ipvs.png)</center>
...
!!! note "coredns.yaml修改注意"
    ...
    3. 需要修改三个地址:
        ...
        2. 118行，image: k8s.gcr.io/coredns:1.3.1 改为image: coredns/coredns:1.3.1，因为那地址访问不了
