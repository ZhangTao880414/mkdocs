...
<center>![img](../../pictures/container/docker/p2.png)</center>
...
<center>![img](../../pictures/container/docker/p3.png)</center>
...
#### 2.3.5 配置加速源
&#160; &#160; &#160; &#160;docker 下载镜像默认是从 [docker hub](https://hub.docker.com/) 上下载的，但是很慢，所有需要配置从国内的镜像源，下载就很快。首推 [DaoCloud](https://www.daocloud.io/mirror)
...
&#160; &#160; &#160; &#160;镜像不是一个单一的文件，而是有多层构成。可以通过`docker history <ID/NAME> `查看镜像中各层内容及大小，每层
...
<center>![img](../../pictures/container/docker/p1.png)</center>
